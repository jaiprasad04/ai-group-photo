        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          {status === "authenticated" ? (
            <div className="flex items-center">
              {/* Credit Balance indicator (or Unlimited when using custom API Key) */}
        ...
        <div className="fixed inset-0 z-[300] flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
          <div className="bg-bg-card border border-divider w-full max-w-md rounded-xl p-6 space-y-5 shadow-2xl animate-scale-up">
            ...
            <p className="text-xs text-secondary-text leading-relaxed">
              Use your own <strong>MuAPI Key</strong> to generate images directly without consuming or purchasing website credits.
            </p>
